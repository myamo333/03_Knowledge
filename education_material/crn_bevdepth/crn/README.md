...
mntした
ln -s /mnt/f/nuscenes-mini/nuScenes/ data/
```
...
miniのデータセットで実施する場合。150行目を、下記に変更する
...
miniで回すかつGPU一つで回す場合、バッチ修正も追加する。下記の3ファイルを差し替え
evaluators/det_evaluators.py
exps/base_cli.py
layers/backbones/rvt_lss_fpn.py
python exps/det/CRN_r50_256x704_128x128_4key.py --ckpt_path ./checkpoints/CRN_r50_256x704_128x128_4key.pth -e -b 4 --gpus 1
```
